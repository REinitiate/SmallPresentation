...
<body>
	...
	<div class="row" align="center" style="margin-top: 50px;">
		<div id="page_1" class="col-md-6" role="main">
			<img src='${pageContext.request.contextPath}/resources/img_letters/pig.jpg'/>			
			<h4>안녕하세요 제니 언니?</h4>
		...
		<div id="page_2" class="col-md-6" role="main">
			<img src='${pageContext.request.contextPath}/resources/img_letters/sad-mickey.jpg'/ width="50%">			
		...
		<div id="page_4" class="col-md-6" role="main">
			<img src='${pageContext.request.contextPath}/resources/img_letters/two-lion.jpg'/ width="50%">			
