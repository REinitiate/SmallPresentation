 ...
 */
    ...
    function DrawChart(){
    	...
    	var chartData = []; // chartData는 파싱 안하고 데이터 자체로 가져오자.
    ...
    function DrawChart2(div, jsonData){
    	...
    	var chartData = jsonData.timeseries; // chartData는 파싱 안하고 데이터 자체로 가져오자.
...
//	        categoryAxis.inside = true;
	        ...
	        graph.fillColors = "#db4c3c";	        
	        graph.negativeLineColor = "#7f8da9";
	        graph.negativeFillColors = "#7f8da9";
